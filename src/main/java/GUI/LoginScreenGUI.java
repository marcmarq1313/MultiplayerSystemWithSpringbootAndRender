...
public class LoginScreenGUI extends JFrame {
    ...
    public LoginScreenGUI() {
        ...
        // Password with placeholder and asterisks
        ...
        // Losses field (registration only)
...
class JTextFieldHintUI extends javax.swing.plaf.basic.BasicTextFieldUI implements java.awt.event.FocusListener {
    ...
    @Override
    public void focusGained(java.awt.event.FocusEvent e) { getComponent().repaint(); }
    @Override
    public void focusLost(java.awt.event.FocusEvent e) { getComponent().repaint(); }
    @Override
    protected void installListeners() { super.installListeners(); getComponent().addFocusListener(this); }
    @Override
